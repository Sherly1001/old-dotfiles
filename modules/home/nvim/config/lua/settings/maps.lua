...
keymap('n', ';rl', ':so ~/dotfiles/modules/home/nvim/config/init.lua<cr>', opts_sl)
keymap('n', ';rc', ':e ~/dotfiles/modules/home/nvim/config/init.lua<cr>', opts_sl)
keymap('n', ';s', ':e ~/dotfiles/modules/home/nvim/config/lua/settings/options.lua<cr>', opts_sl)
keymap('n', ';m', ':e ~/dotfiles/modules/home/nvim/config/lua/settings/maps.lua<cr>', opts_sl)
keymap('n', ';l', ':e ~/dotfiles/modules/home/nvim/config/lua/lsp/lsp.lua<cr>', opts_sl)
keymap('n', ';id', ':e ~/dotfiles/modules/home/nvim/config/lua/settings/indent.lua<cr>', opts_sl)
